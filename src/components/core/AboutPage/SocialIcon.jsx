...
import "./SocialIcons.css"; // Import the CSS file containing styless

function SocialIcon({ href, ariaLabel, dataSocial }) {
  return (
    <li className="icon-content">
      ...
      >
        ...
        {getIcon(dataSocial)}{" "}
        {/* Call function to render appropriate SVG icon */}
      </a>
      <div className="tooltip">{ariaLabel}</div>
    </li>
  );
}

// Function to render appropriate SVG icon based on data-social value
function getIcon(dataSocial) {
  switch (dataSocial) {
    // linkedin
    case "linkedin":
      return (
